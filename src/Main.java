...
public class Main {
    ...
    public static final String INSERTQUERY1="INSERT INTO EMPLOYEE VALUES (1,'RDJ',100)";
    public static final String INSERTQUERY2="INSERT INTO EMPLOYEE VALUES (2,'ANTHYUSH',200)";
    public static final String INSERTQUERY3="INSERT INTO EMPLOYEE VALUES (3,'CHRIS EVANS',200)";
    public static final String SELECTQUERY="SELECT * FROM EMPLOYEE;";
    public static final String UPDATEQUERY = "update EMPLOYEE set empName='Akhilesh' where empId=2";
    public static final String DELETEQUERY = "delete from EMPLOYEE where empSalary=200";
